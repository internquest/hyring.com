                    ...
                    <div class="box-border border-[0px] border-[solid] border-[rgb(229,231,235)] absolute -left-[20px] -top-[20px] m-0 p-0">
                        <div class="box-border border-[0px] border-[solid] border-[rgb(229,231,235)] relative m-0 p-0">
                            <svg width="40" height="42" fill="#B9C8FF"
                                xmlns="http://www.w3.org/2000/svg" class="box-border border-[0px] border-[solid] border-[rgb(229,231,235)] block align-middle animate-[5s_linear_0s_infinite_normal_none_running_spin] fill-[rgb(252,_178,_178)] m-0 p-0">
                            ...
                            <div class="box-border border-[0px] border-[solid] border-[rgb(229,231,235)] absolute left-[15px] top-[22%] font-[var(--font-whyte-medium)] m-0 p-0">7</div>
                        </div>
                    </div>
                </div>
                <div class="box-border bg-custom-green  border-[solid] border-[rgb(229,231,235)] absolute h-[64px] w-full rounded-[12px] border-2 m-0 p-0 left-[7px] top-[7px]"></div>
            </div>
        </div>
 </div>
  )
