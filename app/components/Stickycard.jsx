...
const Stickycard = ({topval,zval}) => {
  return (
   <div style={{top:`${topval}rem`,zIndex:`${zval}`}} class={`sticky   h-full`}>
    <div class="w-full h-[100vh] grid grid-cols-1 justify-center   
                px-2   bg-white border-2  xs:px-[20px] md:px-10 lg:px-16 xl:px-[80px] pt-14 rounded-t-[60px] sm:rounded-t-[100px] lg:rounded-t-[120px] xl:rounded-t-[140px] border-primary-brown   ">
                    <div>
